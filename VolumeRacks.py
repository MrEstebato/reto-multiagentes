...
print(
    "El volumen total de los racks refrigerados es: ", Vol_total_racksR / 1000000, "m^3"
)
...
largo_camara = (
    Dim_rackR[0] * 2
) * 1.4  # Espacio para 2 racks en profundidad + 40% margen
...
print(
    f"Volumen de la cámara: {(altura_camara * ancho_camara * largo_camara)/1000000:.2f} m^3"
)
