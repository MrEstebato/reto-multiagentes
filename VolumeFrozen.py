...
dimensiones_congelados = productos[
    productos["PRODUCTO"]
    .str.strip()
    .isin(["MARQUETA ALITAS", "PAPAS A LA FRANCESAS", "BONELESS"])
...
cantidades["Product"] = cantidades["Product"].replace(
    "PAPAS MCCAIN", "PAPAS A LA FRANCESAS"
)

cantidades = cantidades.rename(columns={"Product": "PRODUCTO", "Quantity": "Cantidad"})

dimensiones_congelados = dimensiones_congelados.merge(
    cantidades, on="PRODUCTO", how="left"
)
...
dimensiones_congelados["Volumen_total_cm3"] = (
    dimensiones_congelados["Volumen_cm3"] * dimensiones_congelados["Cantidad"]
)
dimensiones_congelados["Volumen_total_m3"] = (
    dimensiones_congelados["Volumen_total_cm3"] / 1000000
)
